...
let name = "Piper"
let number =  20
let adjective = "shiny red"
let noun = "skateboard"
let place = "store"
let positiveEmotion = "excited"
let negativeEmotion = "disappointed"
let shortStory = "Today was a big day for \(name). They finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(noun)! "
