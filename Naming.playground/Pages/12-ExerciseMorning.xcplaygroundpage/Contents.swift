...
let totalTime = brushTeeth + washFace + findClothes + getDressed + accersorize + packBag + eatBreakfast + beOnPhone
...
let timeForLikeToDo = brushTeeth + washFace + findClothes + getDressed + eatBreakfast
let timeForHaveToDo = accersorize + packBag + beOnPhone
...
*/
// accersorize is now included in getting dressed

// bursh teeth and wash face included in bathroom hygiene
let bathroomHygeine = 7
let phoneTime = 8

// eating breakfast
let refuel = 10
// finding clothes and getting dressed
let dressUp = 8

let newTotalTime = bathroomHygeine + phoneTime + refuel + dressUp
